...
def cover():
    print """
     ...
     """
    runntek(GL+"           Te hackeare tu pinche cuenta Marisol   ^_^...")
    time.sleep(1)
    print " "
    print RR+"  +============================================+"
...
passwordlist = str(raw_input(WW+" â€¢Ingrese el archivo de Contraseñas\033[95m[ diccionarioM.txt, diccionario M1.txt, diccionarioM2.txt ] \033[92;1m: "))
